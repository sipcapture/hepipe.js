 ...
 *
 Usage:
	nodejs pullstats.js -debug true -ES 'https://test.facetflow.io:443' -t 15
 Daemonize using forever:
	npm install forever -g
	forever start pullstats.js
*/ 
...
/******** Settings Section ********/
	...
	var es_user = 'admin:elasticFence'; 
...
console.log('Starting JSAgent '+version+' on port: '+api_port);
...
var bufferMe = function(data){
	...
	// Fix mapping inconsistencies in Janus native format, for science
